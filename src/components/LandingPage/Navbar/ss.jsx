...
const ss = () => {
  return (
    <div>
      <nav
        className="relative max-w-[85rem] rounded-[36px] mx-3 md:mx-8 lg:mx-12 xl:mx-16 py-1 px-7 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 2xl:mx-auto w-full bg-white border border-gray-200 flex flex-wrap md:grid-cols-12 basis-full items-center"
        aria-label="Global"
      >
        ...
        <div
          ...
          className="py-3 md:py-5 hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block md:w-auto md:basis-auto md:order-2 md:col-span-6"
        >
          <hr className="bg-red md:hidden lg:hidden" />
